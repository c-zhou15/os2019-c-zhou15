...
alloc_proc(void) {
     ...
     */
     //LAB5 2015011248 : (update LAB4 steps)
    /*
     * below fields(add in LAB5) in proc_struct need to be initialized	
     *       uint32_t wait_state;                        // waiting state
     *       struct proc_struct *cptr, *yptr, *optr;     // relations between processes
	 */
     //LAB6 2015011248 : (update LAB5 steps)
    /*
     ...
     */
    //LAB8:EXERCISE2 2015011248 HINT:need add some code to init fs in proc_struct, ...
    return proc;
}
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    //      8.返回子进程的pid
    ret = proc->pid;
    //LAB4:EXERCISE2 2015011248
    //LAB8:EXERCISE2 2015011248  HINT:how to copy the fs in parent's proc_struct?
    /*
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2015011248  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
